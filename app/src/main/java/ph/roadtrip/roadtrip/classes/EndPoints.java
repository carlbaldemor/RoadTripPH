...
public class EndPoints {
    ...
    private static final String ROOT_IP = "192.168.1.3";

    private static final String ROOT_URL = "http://" + ROOT_IP +"/api/roadtrip/fileupload.php?apicall=";
    public static final String UPLOAD_URL = ROOT_URL + "uploadpic";
    public static final String GET_PICS_URL = ROOT_URL + "getpics";

    //File Upload
    private static String ROOT_ATTACHMENT_URL = "http://" + ROOT_IP +"/api/roadtrip/fileupload_attachment.php?apicall=";
    ...
    private static final String ROOT_CARPICS_URL = "http://" + ROOT_IP +"/api/roadtrip/addcaraddpics.php?apicall=";
    ...
    private static final String ROOT_CAR_ATTACH_OR = "http://" + ROOT_IP +"/api/roadtrip/fileupload_OR.php?apicall=";
    ...
    private static final String ROOT_CAR_ATTACH_CR = "http://" + ROOT_IP +"/api/roadtrip/fileupload_CR.php?apicall=";
    public static final String UPLOAD_CAR_ATTACH_CR_URL = ROOT_CAR_ATTACH_CR + "uploadpic";
    //public static final String GET_CAR_PICS_URL = ROOT_CAR_ATTACH_OR + "getpics";

    //Upload Car Attachments SIR
    private static final String ROOT_CAR_ATTACH_SIR = "http://" + ROOT_IP +"/api/roadtrip/fileupload_SIR.php?apicall=";
