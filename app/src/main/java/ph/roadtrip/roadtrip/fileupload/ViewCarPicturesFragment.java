...
public class ViewCarPicturesFragment extends android.support.v4.app.Fragment {
    ...
    private List<CarPictures> reviewlist = new ArrayList<>();
    private ListView listView;
    private CustomListCarPicturesAdapter adapter;
    private SessionHandler session;

    public ViewCarPicturesFragment() {
        // Required empty public constructor
    }

    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_view_car_pictures, container, false);
        reviewlist.clear();
        //ListView
        listView = (ListView) view.findViewById(R.id.listview);
        adapter = new CustomListCarPicturesAdapter(getActivity(), reviewlist);
        ...
        String url = urlBean.getViewcarpictures()+recordID;
        final String getPic = urlBean.getGetPicUrl();
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        CarPictures movie = new CarPictures();
                        movie.setAttachment(getPic+obj.getString("attachment"));
                        movie.setCarpictureID(obj.getInt("carpictureID"));
