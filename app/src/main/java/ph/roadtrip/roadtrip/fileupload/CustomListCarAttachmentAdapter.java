...
public class CustomListCarAttachmentAdapter extends BaseAdapter {
    private SessionHandler session;
    private Activity activity;
    private int brandPos;
    private int modelPos;
    private LayoutInflater inflater;
    private List<CarAttachments> toReviewItems;
    ImageLoader imageLoader = MyApplication.getInstance().getImageLoader();

    public CustomListCarAttachmentAdapter(Activity activity, List<CarAttachments> toReviewItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        CarAttachments m = toReviewItems.get(position);
        ...
        attachType.setText(m.getAttachmentType());

        final CarAttachments items = toReviewItems.get(position);
