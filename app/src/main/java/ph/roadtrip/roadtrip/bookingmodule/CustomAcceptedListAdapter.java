...
public class CustomAcceptedListAdapter extends BaseAdapter {
    ...
    public CustomAcceptedListAdapter(Activity activity, List<BookingRequests> movieItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_accepted_layout, null);
        ...
        btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ViewAcceptedBooking fragment = new ViewAcceptedBooking();
