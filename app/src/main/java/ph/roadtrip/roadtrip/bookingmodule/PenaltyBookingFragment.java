...
public class PenaltyBookingFragment extends Fragment {

    // Log tag
    private static final String TAG = PenaltyBookingFragment.class.getSimpleName();

    // Movies json url
    private String url;
    private ProgressDialog pDialog;
    private List<PenaltyBean> movieList = new ArrayList<PenaltyBean>();
    private ListView listView;
    private CustomPenaltyListAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new CustomPenaltyListAdapter(getActivity(), movieList);
        ...
        url = getUrl.getPenaltyList()+userID;
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        PenaltyBean movie = new PenaltyBean();
                        ...
                        movie.setYear(obj.getString("modelYear"));
                        movie.setPenaltyStatus(obj.getString("penaltyStatus"));
                        movie.setPenaltyFee(obj.getDouble("penaltyFee"));
                        movie.setDateAdded(obj.getString("penaltyDateAdded"));
