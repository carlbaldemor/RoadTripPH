...
public class CustomFavoritesHomeAdapter extends BaseAdapter {
    ...
    public CustomFavoritesHomeAdapter(Activity activity, List<MyFavorites> favoriteItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_favorite_home, null);
