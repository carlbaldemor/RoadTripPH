    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sedan.setOnClickListener(new View.OnClickListener() {
            ...
            serviceType = ServiceSpinner.getSelectedItem().toString();
                ...
                if (date != null && date2 != null) {
                    ...
                    Toast.makeText(getApplicationContext(), myDate + " " + myDate2, Toast.LENGTH_SHORT).show();

                    Intent i = new Intent(BookServiceFavoritesActivity.this, MapsActivity.class);
        ...
        pickup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String startDateTime = dateStart+startTime;
                String endDateTime = dateEnd+returnTime;
                Toast.makeText(getApplicationContext(), sdate + " " + edate, Toast.LENGTH_SHORT).show();
                Date date = null;
                Date date2 = null;
                try {
                    date = inFormat.parse(startDateTime);
        ...
        AccessTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                timepickerdialog = new TimePickerDialog(BookServiceFavoritesActivity.this,
