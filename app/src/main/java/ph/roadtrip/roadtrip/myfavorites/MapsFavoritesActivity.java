...
public class MapsFavoritesActivity extends BaseActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyFavorites myFavorites = session.getOwnerIDFavorites();
        ownerID = myFavorites.getOwnerID();
        ...
        url = getUrl.getListCarsMaps()+startDate+"&endDate="+endDate+"&serviceType="+serviceType+"&carType="+getCarType+"&ownerID="+ownerID;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(MapsFavoritesActivity.this,brandName,modelName,address);
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        /*mMap.addMarker(new MarkerOptions()
                                .position(latLng)
                                .title(brandName + " " + modelName + " (" + amount + ")")
                                .snippet(address)
                                .icon(BitmapDescriptorFactory.fromBitmap(getMarkerBitmapFromView(R.drawable.ic_sedan)))).setTag(obj);*/
                        DecimalFormat df = new DecimalFormat("#,###.00");
                        Double amt = Double.parseDouble(amount);
                        if (carType.equals("Sedan")){
                            mMap.addMarker(new MarkerOptions()
                                    .position(latLng).title(recordID + brandName + " " + modelName + " (" + String.valueOf("₱" + df.format(amt)) + "")
                                    .snippet(carType+"\n"+status+"\n"+"2nd Line Text"+"\n"+address)
                        ...
                        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
                            ...
                            public View getInfoContents(Marker marker) {
                                ...
                                LinearLayout info = new LinearLayout(MapsFavoritesActivity.this);
                                info.setOrientation(LinearLayout.VERTICAL);

                                TextView title = new TextView(MapsFavoritesActivity.this);
                                title.setTextColor(Color.BLACK);
                                title.setGravity(Gravity.CENTER);
                                title.setTypeface(null, Typeface.BOLD);
                                title.setText(marker.getTitle());

                                TextView snippet = new TextView(MapsFavoritesActivity.this);
                                ...
                                mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                                    ...
                                    public void onInfoWindowClick(Marker marker) {
                                        Intent i = new Intent(MapsFavoritesActivity.this, ViewBookingOfferActivity.class);
