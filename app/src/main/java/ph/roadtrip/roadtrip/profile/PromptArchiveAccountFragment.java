...
public class PromptArchiveAccountFragment extends Fragment {

    private TextView tvStartDate, tvEndDate, tvBrandName, tvModelName, tvFullname, tvTotalAmount, tvCarType, tvServiceType;
    private Button btnAccept, btnDecline, btnArchived, btnCancel;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_prompt_archive_account, container, false);
        ...
        archive_record = urlBean.getArchive_account(); // change this
        urlCheckPassword = urlBean.getCheck_password();

        btnArchived = view.findViewById(R.id.btnArchive);
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(user.getUserTypeID() == "1"){
                    ...
                    FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                    FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                    fragmentTransaction.replace(R.id.fragment_container, new EditProfileOwnerFragment());
                    fragmentTransaction.addToBackStack(null);
                    fragmentTransaction.commit();
                }
    ...
    public void archive(){
        ...
        JsonObjectRequest jsArrayRequest = new JsonObjectRequest(Request.Method.POST, archive_record, request, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
                    //Check if user got logged in successfully
