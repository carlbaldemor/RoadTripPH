...
import ph.roadtrip.roadtrip.bookingmodule.CustomAcceptedListAdapter;
...
public class ListChatsFragment extends Fragment {
    ...
    // Log tag
    private static final String TAG = ListChatsFragment.class.getSimpleName();
