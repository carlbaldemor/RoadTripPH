...
public class ListMessagesOwnerFragment extends Fragment {


    // Log tag
    private static final String TAG = ListMessagesOwnerFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        url = getUrl.getChatMessagesOwner()+chatID;
