...
public class ChatListOwnerAdapter extends BaseAdapter {
    ...
    public ChatListOwnerAdapter(Activity activity, List<Messages> chatsItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ListMessagesOwnerFragment fragment = new ListMessagesOwnerFragment();
