...
public class ListCarToReviewFragment extends Fragment {

    // Log tag
    private static final String TAG = ListCarToReviewFragment.class.getSimpleName();
    ...
    private CustomCarReviewAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new CustomCarReviewAdapter(getActivity(), toReviewList);
        ...
        url = getUrl.getCarToReviewList()+userID;
