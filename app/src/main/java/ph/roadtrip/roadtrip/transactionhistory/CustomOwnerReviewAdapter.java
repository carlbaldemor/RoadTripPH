...
public class CustomOwnerReviewAdapter extends BaseAdapter {
    ...
    public CustomOwnerReviewAdapter(Activity activity, List<Booking> toReviewItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                session.setBookingIDHistoryOwner(items.getBookingID(), items.getRenter_userID());
