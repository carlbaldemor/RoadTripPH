...
public class ListTransactionHistoryOwnerFragment extends Fragment {


    // Log tag
    private static final String TAG = ListTransactionHistoryOwnerFragment.class.getSimpleName();
    ...
    private CustomHistoryOwnerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new CustomHistoryOwnerAdapter(getActivity(), transactionList);
        ...
        url = getUrl.getGet_history_owner()+ownerID;
